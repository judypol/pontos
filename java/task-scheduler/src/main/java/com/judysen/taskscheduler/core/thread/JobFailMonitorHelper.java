package com.judysen.taskscheduler.core.thread;
...
import com.judysen.taskscheduler.core.util.email.MailUtil;
...
public class JobFailMonitorHelper {
	...
	private static final String mailBodyTemplate = "<h5>" + "监控告警明细" + "：</h5>" +

package com.judysen.taskscheduler.controller.interceptor;
...
import com.judysen.taskscheduler.core.util.CookieUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
    ...
    static {
        String username = TaskSchudulerConfiguration.getAdminConfig().getLoginUsername();
        String password = TaskSchudulerConfiguration.getAdminConfig().getLoginPassword();
